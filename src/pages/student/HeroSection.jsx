...
const HeroSection = () => {
  ...
  return (
    <div className="relative bg-gradient-to-r from-blue-700 to bg-indigo-800 dark:from-gray-800 dark:to-gray-900 py-24 px-4 text-center">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-white text-4xl font-bold mb-4">
          Explore Top Courses Tailored for You
        </h1>
        <p className="text-gray-200 dark:text-gray-400 mb-8">
          Learn, Grow, and Advance with Our Comprehensive Course Selection.
        </p>
